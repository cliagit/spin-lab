...
'''
 ...
 Version which plot V vs I and R vs T
'''
   ...
   # print(i, T[i], R[i])
    ...
    if not start_measurements:
        ...
        if N > DISPLAY_SAMPLES:
            ...
            ax0.plot(T[N - DISPLAY_SAMPLES:-1], R[N - DISPLAY_SAMPLES:-1], '.-', color='orange')
            ax1.plot(I[N - DISPLAY_SAMPLES:-1], V[N - DISPLAY_SAMPLES:-1], '.-', color='red')
