...
__used __section("__versions") = {
	...
	{ 0x37a0cba, "kfree" },
	{ 0x9e7d6bd0, "__udelay" },
	{ 0x3ddf5fea, "gpiod_get_raw_value" },
	{ 0x1bd598ba, "gpio_to_desc" },
	{ 0xc5850110, "printk" },
